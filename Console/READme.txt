...
credentials.json -- your developer credentials
...
You should keep your YouTube credentials in a file "credentials.json"
...
Note that I programmed this as a "developer". You may need to be one.
As a developer you can setup a project for an "app" and get credentials.


This code will work in a shell that's not native (like on Windows),
like Git Bash, or Ubuntu bash.  I haven't done this, but you can probanbly
get this running in a powershell.  Running in a gui sort of defeats
the purpose; just use the YouTube website.

Do '--help' to see the cmd line arguments.
